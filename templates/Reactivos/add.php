...
<div class="reactivos form">
 ...
 ['confirm' => __('¿Estás seguro de que quieres eliminar este reactivo?'), 'class'
=> 'side-nav-item button button-outline']
 ) ?>
 <?php endif; ?>
 <?= $this->Html->link(__('Listar Reactivos'), ['action' => 'index'], ['class' => 'sidenav-item']) ?>
 </div>
 </aside>
