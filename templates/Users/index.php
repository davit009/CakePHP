...
<div class="users index content">
 ...
 <?= $this->Html->link(__('Crear Nuevo Usuario'), ['action' => 'add'], ['class'
=> 'button float-right']) ?>
 </div>
...
'Usuario Base' ?>
 ...
 <td>
 <span class="badge badge-status-<?= $user->active ? 'active' :
'inactive' ?>">
...
$user->id], ['confirm' => __('¿Estás seguro de que quieres eliminar a {0}?',
$user->email), 'class' => 'button button-outline button-small delete-btn']) ?>
 <?php endif; ?>
 </td>
 </tr>
 <?php endforeach; ?>
